...
public class CreateNewPastePage {
    ...
    private final By selectHighlightingBy = By.xpath("//div[@class='form-group field-postform-format']//*[@class='selection']");
    ...
    public void setBashHighlighting() {
        WebElement selectHighlighting = driver.findElement(selectHighlightingBy);
